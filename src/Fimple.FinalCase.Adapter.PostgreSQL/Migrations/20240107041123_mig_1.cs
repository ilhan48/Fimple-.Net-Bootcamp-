        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AutomaticPayments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditApplications_Users_ApplicantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AskingId = table.Column<int>(type: "integer", nullable: false),
                    AnsweringId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportTickets_Users_AnsweringId",
                        column: x => x.AnsweringId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupportTickets_Users_AskingId",
                        column: x => x.AskingId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CreditApplicationId = table.Column<int>(type: "integer", nullable: false),
                    InstallmentAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    NumberOfInstallment = table.Column<short>(type: "smallint", nullable: false),
                    RemainingInstallment = table.Column<short>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentPlans_CreditApplications_CreditApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutomaticPayments_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentPlans_CreditApplicationId",
                table: "PaymentPlans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportTickets_AnsweringId",
                table: "SupportTickets",
                column: "AnsweringId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportTickets_AskingId",
                table: "SupportTickets",
                column: "AskingId");
